        ...
        <div class="container">
            <div class="search-window">
                      ...
                      <div class="search-wrap">
                        <label for="search" class="blind">모바일 공지사항검색</label>
                        <input id="search" type="search" name="key" placeholder="검색어를 입력해주세요." value="${key}">
                        <button type="submit" class="btn btn-dark" value="검색" onClick="go_search('mobileNotice')">검색</button>
                 		<button type="submit" class="btn btn-darkkk" value="전체보기" onClick="go_total('mobileNotice')">전체보기</button>  
                    </div>
        ...
        <div class="container">
            <table class="board-table">
                ...
                <c:forEach items="${notice}" var="noticeVO">
	                <tr>
	                    <td>${noticeVO.nseq}</td>
	                    <th><a href="mobileNoticeDetail?nseq=${noticeVO.nseq}">${noticeVO.title}</a></th>
